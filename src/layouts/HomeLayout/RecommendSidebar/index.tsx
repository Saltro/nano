    ...
    <div id={style.container}>
      ...
      <div className={style.cityRec}>
        ...
        <div className={style.cityImages}>
          <Image title="东京" src="http://qiniu-picgo.saltroping.com/city1.jpg" />
          <Image title="京都" src="http://qiniu-picgo.saltroping.com/city2.jpg" />
          <Image title="镰仓" src="http://qiniu-picgo.saltroping.com/city3.jpg" />
        </div>
      </div>
      <div className={style.strategy}>
        ...
        <div className={style.images}>
          <Image src="http://qiniu-picgo.saltroping.com/路线.png" />
          <Image src="http://qiniu-picgo.saltroping.com/交通.png" />
          <Image src="http://qiniu-picgo.saltroping.com/季节.png" />
          <Image src="http://qiniu-picgo.saltroping.com/技巧.png" />
        </div>
      </div>
    </div>
  );
